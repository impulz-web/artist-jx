...
export const ARTIST_NAME = "JX";
export const ARTIST_TAGLINE = "Rising Star Artist";

export const INITIAL_HERO_IMAGE = "/hero.jpg";

export const INITIAL_STREAMING_LINKS: StreamingLink[] = [
  { id: '1', platform: 'Spotify', url: 'https://benardopro.online', label: 'Spotify' },
  { id: '2', platform: 'Instagram', url: 'https://benardopro.online', label: 'Instagram' },
  { id: '3', platform: 'Facebook', url: 'https://benardopro.online', label: 'Facebook' },
  { id: '4', platform: 'TikTok', url: 'https://benardopro.online', label: 'TikTok' },
  { id: '5', platform: 'YouTube', url: 'https://benardopro.online', label: 'YouTube' },
];
...
export const INITIAL_ABOUT_DATA: AboutData = {
  ...
  description1: `${ARTIST_NAME} is an artist known for high-energy performances, authentic storytelling, and a bold sound that represents ambition, resilience, and the voice of a new generation.`,
